  ...
  return (
    <div className="flex flex-col items-center bg-muted p-8 overflow-auto print:bg-white print:p-0 print-container">
      ...
      >
          ...
          {documentType === 'spa' ? (
            ...
            <>
              ...
              <div className="no-break mt-4">
                ...
                <div className={cn("flex flex-col items-center ml-auto mr-0 w-fit", documentType === 'sec_dispute' ? "mb-2 mt-4" : "mb-4 mt-10")}>
        ...
        <div className={cn("no-break flex flex-col", documentType === 'sec_dispute' ? "mt-2 pt-0" : "mt-4 pt-2")}>
          {documentType === 'spa' ? (
            <>
              <div className="text-center font-bold mb-12 uppercase">
                ACKNOWLEDGEMENT
          ...
          <div className={cn("flex justify-between items-start", documentType === 'sec_dispute' ? "mt-4" : "mt-8")}>
